#############################################################################
# Makefile for building: A2_handout_2\ 2.app/Contents/MacOS/A2_handout_2\ 2
# Generated by qmake (3.1) (Qt 6.6.0)
# Project:  A2_handout_2 2.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile A2_handout_2\ 2.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = A2_handout_2\ 21.0.0
DISTDIR = /Users/shabaazh/Desktop/A2_handout_2\ 2/.tmp/A2_handout_2\ 21.0.0
...
SOURCES       = AnimationCycleWidget.cpp \
		...
		Quaternion.cpp \
		SceneModel.cpp \
		Terrain.cpp moc_AnimationCycleWidget.cpp
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		A2_handout_2 2.pro AnimationCycleWidget.h \
		BVHData.h \
		Camera.h \
		Cartesian3.h \
		Homogeneous4.h \
		...
		Quaternion.h \
		SceneModel.h \
		Terrain.h AnimationCycleWidget.cpp \
		BVHData.cpp \
		Camera.cpp \
		Cartesian3.cpp \
		Homogeneous4.cpp \
		...
		SceneModel.cpp \
		Terrain.cpp
QMAKE_TARGET  = A2_handout_2\ 2
DESTDIR       = 
TARGET        = A2_handout_2\ 2.app/Contents/MacOS/A2_handout_2\ 2

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 14.0
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/shabaazh/Desktop/A2_handout_2 2/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/shabaazh/Desktop/A2_handout_2 2/A2_handout_2 2.pro
...
A2_handout_2\ 2.app/Contents/MacOS/A2_handout_2\ 2:  $(OBJECTS)  
	@test -d A2_handout_2\ 2.app/Contents/MacOS/ || mkdir -p A2_handout_2\ 2.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: A2_handout_2\ 2.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.6.0/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile A2_handout_2\ 2.pro
...
A2_handout_2\ 2.app/Contents/PkgInfo: 
	@test -d A2_handout_2\ 2.app/Contents || mkdir -p A2_handout_2\ 2.app/Contents
	@$(DEL_FILE) A2_handout_2\ 2.app/Contents/PkgInfo
	@echo "APPL????" > A2_handout_2\ 2.app/Contents/PkgInfo
A2_handout_2\ 2.app/Contents/Info.plist: 
	@test -d A2_handout_2\ 2.app/Contents || mkdir -p A2_handout_2\ 2.app/Contents
	@$(DEL_FILE) A2_handout_2\ 2.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.A2-handout-2-2,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.A2-handout-2-2,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,A2_handout_2 2,g" -e "s,@LIBRARY@,A2_handout_2 2,g" -e "s,\$${EXECUTABLE_NAME},A2_handout_2 2,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >A2_handout_2\ 2.app/Contents/Info.plist

all: Makefile \
		A2_handout_2\ 2.app/Contents/PkgInfo \
		A2_handout_2\ 2.app/Contents/Info.plist A2_handout_2\ 2.app/Contents/MacOS/A2_handout_2\ 2
...
distdir: FORCE
	...
	$(COPY_FILE) --parents AnimationCycleWidget.h BVHData.h Camera.h Cartesian3.h Homogeneous4.h HomogeneousFaceSurface.h Matrix4.h Quaternion.h SceneModel.h Terrain.h $(DISTDIR)/
	$(COPY_FILE) --parents AnimationCycleWidget.cpp BVHData.cpp Camera.cpp Cartesian3.cpp Homogeneous4.cpp HomogeneousFaceSurface.cpp main.cpp Matrix4.cpp Quaternion.cpp SceneModel.cpp Terrain.cpp $(DISTDIR)/
...
moc_predefs.h: /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp
	/Library/Developer/CommandLineTools/usr/bin/clang++ -pipe -stdlib=libc++ -DGL_SILENCE_DEPRECATION -O2 -std=gnu++1z $(EXPORT_ARCH_ARGS) -isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk -mmacosx-version-min=14.0 -Wall -Wextra -dM -E -o moc_predefs.h /opt/homebrew/share/qt/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_AnimationCycleWidget.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_AnimationCycleWidget.cpp
moc_AnimationCycleWidget.cpp: AnimationCycleWidget.h \
	...
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/shabaazh/Desktop/A2_handout_2 2/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/shabaazh/Desktop/A2_handout_2 2' -I'/Users/shabaazh/Desktop/A2_handout_2 2' -I/opt/homebrew/lib/QtOpenGLWidgets.framework/Headers -I/opt/homebrew/lib/QtOpenGL.framework/Headers -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib AnimationCycleWidget.h -o moc_AnimationCycleWidget.cpp
